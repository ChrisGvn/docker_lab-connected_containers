...
INSERT INTO `products` (`id`,`prodName`,`prodDesc`,`prodCategory`,`prodStock`,`prodImageLink`,`price`) VALUES (3,'Ferrari F1-75 Die Cat Model','These beloved children\'s stories are now available in beginning reader format. Complete with an introduction by master educator Laura Robb, and with fun reading activities added, these new versions of Brown Bear, Brown Bear, What Do You See? and Polar Bear, Polar Bear, What Do You Hear? are certain to appeal to a new age group and find an even wider audience. ','5','3','car.jpg',24.99);
